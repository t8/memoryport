...
function StatusBadge({ status }: { status: IStatus }) {
  const config = {
    operational: { icon: CheckCircle2, color: "text-emerald-400", label: "Active" },
    down: { icon: XCircle, color: "text-red-400", label: "Down" },
    unconfigured: { icon: MinusCircle, color: "text-zinc-500", label: "Off" },
  }[status];
...
export default function Integrations() {
  ...
  return (
    <div className="p-8 max-w-4xl space-y-8">
      ...
      <div className="rounded-lg border border-blue-900/30 bg-blue-950/20 px-4 py-3 text-sm text-blue-300/80">
          ...
          {mcpEnabled && (
            <div className="mt-3 pt-3 border-t border-zinc-800 grid grid-cols-3 gap-4 text-xs">
              <div>
                ...
                <p className="text-zinc-300 mt-0.5">stdio</p>
              </div>
              <div>
                <span className="text-zinc-500">Tools</span>
                <p className="text-zinc-300 mt-0.5">7 tools, 2 resources</p>
              </div>
              <div>
                <span className="text-zinc-500">Auto-capture</span>
                <p className="text-zinc-300 mt-0.5">Via uc_auto_store</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-medium text-sm">API Proxy</h3>
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-medium text-sm">Arweave Storage</h3>
          ...
          {arweaveEnabled && (
            <div className="mt-3 pt-3 border-t border-zinc-800 grid grid-cols-3 gap-4 text-xs">
              <div>
                ...
                <p className="text-zinc-300 mt-0.5">arweave.net</p>
              </div>
              <div>
                <span className="text-zinc-500">Wallet</span>
                <p className="text-zinc-300 mt-0.5">Configured</p>
              </div>
              <div>
                <span className="text-zinc-500">Cost</span>
                <p className="text-zinc-300 mt-0.5">~$7/GB (pay once)</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-medium text-sm">Embedding Provider</h3>
          ...
          <div className="mt-3 pt-3 border-t border-zinc-800 grid grid-cols-3 gap-4 text-xs">
            <div>
              ...
              <p className="text-zinc-300 mt-0.5">{status?.embedding_model || "—"}</p>
            </div>
            <div>
              <span className="text-zinc-500">Dimensions</span>
              <p className="text-zinc-300 mt-0.5">{status?.embedding_dimensions || "—"}</p>
            </div>
            <div>
              <span className="text-zinc-500">Indexed</span>
              <p className="text-zinc-300 mt-0.5">{status ? `${status.indexed_chunks} chunks` : "—"}</p>
            </div>
          </div>
        </div>
      </div>
